...
public class MessageService {
    @Autowired
    private MessageRepository messageRepository; //Nos tratemos lo de la capa anterior
    ...
    public Message save(Message message){ //Metodo que crea un elemento nuevo en una tabla, por lo que requiere seguridad
